...
class Genre(models.Model):
    ...
    # Notes:
    #
    # No verbose name has been defined, so the field 'name' will be called 'Name' in forms.
    #
...
class Book(models.Model):
    ...
    # Notes:
    #
    # The 'isbn' specifies its label as "ISBN" using the first unnamed parameter because the default label would otherwise be "Isbn"
    #
